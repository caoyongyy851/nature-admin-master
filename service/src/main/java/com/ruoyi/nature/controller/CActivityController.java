...
@RestController
@RequestMapping("/nature/activity" )
public class CActivityController extends BaseController {
     ...
     * 查询活动列表
     */
    @PreAuthorize("@ss.hasPermi('nature:activity:list')")
    @GetMapping("/list")
    public TableDataInfo list(CActivity cActivity)
    {
        ...
        if (cActivity.getPerson() != null){
            lqw.eq(CActivity::getPerson ,cActivity.getPerson());
        }
        if (cActivity.getPerLimit() != null){
            lqw.eq(CActivity::getPerLimit ,cActivity.getPerLimit());
        }
     ...
     * 导出活动列表
     */
    @PreAuthorize("@ss.hasPermi('nature:activity:export')" )
     ...
     * 获取活动详细信息
     */
    @PreAuthorize("@ss.hasPermi('nature:activity:query')" )
    @GetMapping(value = "/{id}" )
     ...
     * 新增活动
     */
    @PreAuthorize("@ss.hasPermi('nature:activity:add')" )
     ...
     * 修改活动
     */
    @PreAuthorize("@ss.hasPermi('nature:activity:edit')" )
     ...
     * 删除活动
     */
    @PreAuthorize("@ss.hasPermi('nature:activity:remove')" )
